...
set "$accessKey=YjM3NmU3YWQtNWI4NC0zMmZjLThhOTctNThlMWU4NWQ2YzI4IDYxZjc4MzNmYWNkNGNiMDA2OWNhZjFiYyBVU0VSX0RFRkFVTFRfTkFNRQ"
set "$secretKey=ewM_GKwJe5171PiqBPYEFjhFp3oHb33mC7zOwOxIMEA"
:: Id of the user who will create the automation task. You can find it in Jira.
set "$accountId=61f7833facd4cb0069caf1bc"
